...
export default function GaussSeidelCalculator() {
    ...
    try {
      ...
      while (iteration < maxIter && !converged) {
        ...
        for (let i = 0; i < size; i++) {
          ...
          x[i] = (constants[i] - sum) / matrix[i][i]
        }
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Gauss-Seidel Method Calculator</CardTitle>
          <CardDescription>Solve linear systems using Gauss-Seidel iterative method</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-2">
                <Button onClick={calculateGaussSeidel} className="flex-1">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {result && result.iterations.length > 0 && (
                <Card>
                  <CardHeader>
                    <CardTitle>Gauss-Seidel Iterations</CardTitle>
                    <CardDescription>Convergence history (uses updated values immediately)</CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Gauss-Seidel vs Jacobi</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                      <h4 className="font-semibold text-green-800 dark:text-green-300 mb-2">Gauss-Seidel</h4>
                      <ul className="text-sm space-y-1">
                        <li>• Uses updated values immediately</li>
                        <li>• Generally faster convergence</li>
                        <li>• Less memory required</li>
                        <li>• Sequential computation</li>
                      </ul>
                    </div>
                    <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                      <h4 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">Jacobi</h4>
                      <ul className="text-sm space-y-1">
                        <li>• Uses previous iteration values</li>
                        <li>• Slower convergence</li>
                        <li>• More memory required</li>
                        <li>• Parallel computation possible</li>
                      </ul>
                    </div>
                  </div>
                  <div className="mt-4 bg-slate-100 dark:bg-slate-800 p-4 rounded-lg text-center">
                    <code className="text-lg">x_i^(k+1) = (b_i - Σ(a_ij × x_j^(k+1))) / a_ii</code>
                    <p className="text-sm mt-2">
                      Note: Uses x_j^(k+1) for j {"<"} i and x_j^(k) for j {">"} i
                    </p>
                  </div>
                </CardContent>
              </Card>
